...
import { createUserService, findUserByCredentiaId, getAllUsersService, getUserByIdService } from "../services/userService";
...
export const login = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const user = await findUserByCredentiaId(credential.id)
